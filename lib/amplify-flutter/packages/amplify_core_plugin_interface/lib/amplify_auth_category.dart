...
class AuthCategory {
  ...
  Future<SignUpResult> confirmSignUp(
      {@required String username, @required String confirmationCode, ConfirmSignUpOptions options}) {
  ...
  Future<UpdatePasswordResult> updatePassword(
      {@required String oldPassword, @required String newPassword, PasswordOptions options}) {
  ...
  Future<bool> signInWithWebUI({AuthProvider provider}) {
    ...
    return plugins.length == 1 ? plugins[0].signInWithWebUI(request: request) : throw (errorMsg);
  }
}
